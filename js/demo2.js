{
	...
	const initShapeLoop = function(pos,shapeEl) {
		pos = pos || 0;
	...
	const initShapeEl = function(svg,shapeEl) {
		anime.remove(svg);
		anime({
			targets: svg,
			duration: 1,
		...
		initShapeLoop(null, shapeEl);
	};

	const createScrollWatchers = function(svg,shapeEl) {
	...
	const init = function() {
			initShapeEl(DOM.svg1, DOM.shapeEl1);
			initShapeEl(DOM.svg2, DOM.shapeEl2);
			initShapeEl(DOM.svg3, DOM.shapeEl3);
			createScrollWatchers(DOM.svg1, DOM.shapeEl1);
			createScrollWatchers(DOM.svg2, DOM.shapeEl2);
			createScrollWatchers(DOM.svg3, DOM.shapeEl3);
	};
